...
public class CreateDebitCommandHandler(ITransactionRepository transactionRepository, ILogger<CreateDebitCommandHandler> logger)
{
...
public record CreateDebitCommand(decimal Value, string Description);
